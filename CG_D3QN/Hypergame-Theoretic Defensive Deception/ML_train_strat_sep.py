...
#
#             X_train, X_test, y_train, y_test = train_test_split(strate_dataset_section_X, pd_strate_dataset_section_Y,
#                                                                 test_size=0.1, random_state=1)
#
#             # KNN
#             model = neighbors.KNeighborsRegressor(n_neighbors, weights='distance', algorithm='brute', n_jobs=-1).fit(
#                 X_train, y_train)
...
#
#             X_train, X_test, y_train, y_test = train_test_split(strate_dataset_X, pd_strate_dataset_Y, test_size=0.1,
#                                                                 random_state=1)
#
#             # KNN
#             model = neighbors.KNeighborsRegressor(n_neighbors, weights='distance', algorithm='brute', n_jobs=-1).fit(
...
#                 the_file = open(
#                     "data_vary/AAP=" + str(AAP) + "/trainning_data/" + schemes[schemes_index] + "/" + file_name, "rb")
#                 [ML_x_data_all_result, ML_y_data_all_result] = pickle.load(the_file)
#                 the_file.close()
#
#                 for key in ML_x_data_all_result.keys():
...
#                 the_file = open(
#                     "data_vary/VUB=" + str(VUB) + "/trainning_data/" + schemes[schemes_index] + "/" + file_name, "rb")
#                 [ML_x_data_all_result, ML_y_data_all_result] = pickle.load(the_file)
#                 the_file.close()
#
#                 for key in ML_x_data_all_result.keys():
...
#             the_file = open("data_vary/VUB=" + str(VUB) + "/trained_ML_model/trained_classi_model_" + schemes[
#                 schemes_index] + ".pkl", "wb+")
#             pickle.dump(model, the_file)
#             the_file.close()
#
