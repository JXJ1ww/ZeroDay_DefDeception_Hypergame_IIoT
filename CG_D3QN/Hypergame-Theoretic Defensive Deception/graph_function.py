...
def complexity_index(G_real, connect_prob):
    return connect_prob * (G_real.number_of_nodes() - number_of_evicted_node(G_real))/G_real.number_of_nodes()
...
def beta_l(graph):
    ...
    if total_node_number == 0 :
        Communications_load=0
    else:
        Communications_load=counter / total_node_number
    ...
    # else:
    #     return False
    Response_time=top_total / bottom_total
    return math.exp((-1)*Communications_load*Response_time)
